#monospectrum analysis of vMSE, frequency vs wavenumber on 800 hPa
import numpy as np 
import xarray as xr
...
if __name__ == "__main__":
    fpath1 = "/glade/derecho/scratch/hcluo/MSE/"
    ...
    for i in years:
        for j in np.arange(1,13):
            ...
            for k in days:
                fname1 = "MSE_" \
                +year_month+k+"00_"+year_month+k+"18.nc"

                folder = os.listdir(fpath1)
    ...
    data_selected = xr.decode_cf(ds1,decode_times = True)['MSE'].sel(level = 800)
    ...
    outPlotName = "/glade/work/hcluo/v5/WK_MSE800_symmetric_5_15.pdf"
    wf.plot_normalized_symmetric_spectrum(symComponent, cmap, 
                                          #levels = np.linspace(0.02, 0.2, 10),
                                          ofil = outPlotName)
    
    outPlotName = "/glade/work/hcluo/v5/WK_MSE800_asymmetric_5_15.pdf"
