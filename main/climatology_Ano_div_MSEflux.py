#Composites of divergent component of eddy component of MSE flux
import numpy as np 
import xarray as xr
...
def map_plot(Data,Data2,cmap,fileout):
    ...
    ctitles = r"$\overline{\langle v^{*}' h^{*}' \rangle_D}\;(\times 10^7 \, W\,m^{-1})$"
    
    titles2 = r"$\overline{[\langle v^{*}' h^{*}' \rangle_D]}\;(\times 10^7 \, W\,m^{-1})$"
...
if __name__ == "__main__":
    ...
    fnames4 = []
    for i in years:
        fname2 = "vMSE_col_transient/div_vMSE_col_transient_"+f"{i}.nc"
    ...
    Data2 = xr.decode_cf(ds2,decode_times = True)['div_vMSE_col_transient']
    ...
    fileout = "/glade/work/hcluo/v5/climatology_Ano_div_MSEflux.pdf"
